...
public class ObjectFactory {
    ...
    private final static QName _SumarResponse_QNAME = new QName("http://bean.core.ws.josebaten.org/", "sumarResponse");
    private final static QName _Sumar_QNAME = new QName("http://bean.core.ws.josebaten.org/", "sumar");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bean.core.ws.josebaten.org/", name = "sumarResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bean.core.ws.josebaten.org/", name = "sumar")
